...
const sampleRouter = require("./routers/samples.routes");
const sampleWorkflowRouter = require("./routers/sampleWorkflow.routes");
...
console.info("Build commit:", APP_COMMIT_SHA, "source:", COMMIT_SOURCE);
...
app.use("/sample-workflows", sampleWorkflowRouter);
