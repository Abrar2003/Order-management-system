...
const ABSOLUTE_MAX_QC_IMAGE_UPLOAD_FILES_PER_REQUEST = 100;
const DEFAULT_QC_IMAGE_UPLOAD_FILES_PER_REQUEST = 100;
const QC_IMAGE_UPLOAD_LIMIT_PER_INSPECTION_RECORD = 150;
const HARDWARE_INSPECTION_IMAGE_LIMIT = 6;
...
const MAX_QC_IMAGE_UPLOAD_COUNT = clampInteger(
  process.env.QC_IMAGE_MAX_UPLOAD_COUNT
    ...
    || DEFAULT_QC_IMAGE_UPLOAD_FILES_PER_REQUEST,
  1,
