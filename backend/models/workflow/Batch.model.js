...
const BatchCountsSchema = new mongoose.Schema(
  {
    ...
    started_tasks: { type: Number, default: 0, min: 0 },
    ...
    reworked_before_approval_tasks: { type: Number, default: 0, min: 0 },
    reworked_after_approval_tasks: { type: Number, default: 0, min: 0 },
